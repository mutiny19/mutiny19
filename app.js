...
const translations = {
    en: {
        ...
        'manifesto.card3.title': 'BUILD TO ACQUIRE',
        'manifesto.card3.desc': 'We build sustainable businesses that acquire others. Community-enriching companies with IPO potential. The real wealth is built after the early exit offers come knocking.',
        ...
        'discord.benefit3.title': 'Empire Builders',
        'discord.benefit3.desc': 'Connect with founders building acquirers, not quick flips. We celebrate builders creating enviable companies worth far more than early exit offers.',
        ...
        'discord.noFees': 'No fees. No applications. No ulterior motives. Just founders building companies worth owning.',
    ...
    es: {
        ...
        'manifesto.card3.title': 'CONSTRUIR PARA ADQUIRIR',
        'manifesto.card3.desc': 'Construimos negocios sostenibles que adquieren otros. Empresas que enriquecen la comunidad con potencial de salida a bolsa. La verdadera riqueza se construye después de que llegan las ofertas de salida temprana.',
        ...
        'discord.benefit3.title': 'Constructores de Imperios',
        'discord.benefit3.desc': 'Conecta con fundadores construyendo adquirentes, no salidas rápidas. Celebramos a constructores creando empresas envidiables que valen mucho más que las ofertas de salida temprana.',
        ...
        'discord.noFees': 'Sin cuotas. Sin aplicaciones. Sin motivos ocultos. Solo fundadores construyendo empresas que vale la pena poseer.',
